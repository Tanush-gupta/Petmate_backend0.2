...
{
    const {name, breed, age,weight, about,category,gender,address,owner} = req.body;
    ...
    return res.status(201).json(
        new ApiResponse(200,createdPet,"Pet added Successfully")
    )
});
...
const getAllPetData = asyncHandler(async (req, res) => 
{
    ...
    return res.status(200).json(new ApiResponse(200, pets, "All pets fetched successfully"));
  }
);
